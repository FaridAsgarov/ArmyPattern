...
import static com.company.view.Constants.SPEARMAN_IMAGE;

public class Spearman extends BaseSoldier {

  public Spearman(String name, SoldierPosition soldierPosition) {
    super(name, 100, new LeatherDecorator(new WoodenShield()), new LeatherArmorComposite(), SPEARMAN_IMAGE, soldierPosition);
